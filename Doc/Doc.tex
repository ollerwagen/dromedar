	...
	\section{Formal Typing Rules}
		...
		\subsection{Expressions}
			...
			\subsubsection{List Comprehension}
				...
				\begin{align*}
					\drmrule{S\ruleapp{E}\mc{l1}::\mc{[t1]},\ \dots,\ S\ruleapp{E}\mc{ln}::\mc{[tn]}\ \ S\sqcup\{(\mc{x1},\mc{t1},c),\dots,(\mc{xn},\mc{tn},c)\}\ruleapp{E}(\mc{e},\mc{c})::(\mc{t},\mc{bool})}{S}{E}{\mc{[e : x1 in l1, ..., xn in ln : c]}::\mc{[t]}}{ExpListComp}
				\end{align*}
