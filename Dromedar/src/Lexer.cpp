...
namespace drm {
    ...
    const std::vector<Token::Type> Lexer::DIRECT_TO_TOKEN = {
        ...
        Token::Type::LOGAND,   Token::Type::LOGOR,
        Token::Type::EQUAL,    Token::Type::NOT_EQUAL,  Token::Type::GREATER,
        Token::Type::LESS,     Token::Type::GREATER_EQ, Token::Type::LESS_EQ,
    ...
    const std::map<Token::Type, std::regex> Lexer::REGEXES = {
        ...
        TRANSLATE(LOGAND), TRANSLATE(LOGOR),
        TRANSLATE(EQUAL), TRANSLATE(NOT_EQUAL), TRANSLATE(GREATER), TRANSLATE(LESS), TRANSLATE(GREATER_EQ), TRANSLATE(LESS_EQ),
    ...
    Lexer::Lexer() {
        static const std::vector<Token::Type> REGEX_ORDER = {
            ...
            Token::Type::ARROW,
            Token::Type::NOT_EQUAL,
            Token::Type::BANG, Token::Type::DASH, Token::Type::STARSTAR, Token::Type::STAR, Token::Type::PLUS,
            Token::Type::LSHIFT, Token::Type::ASHIFT, Token::Type::RSHIFT,
            Token::Type::LOGAND, Token::Type::LOGOR,
            Token::Type::BITAND, Token::Type::XOR, Token::Type::BITOR,
            Token::Type::EQUAL, Token::Type::GREATER_EQ, Token::Type::LESS_EQ, Token::Type::GREATER, Token::Type::LESS,
            Token::Type::ASSIGN, Token::Type::COLON, Token::Type::COMMA,
            Token::Type::LPAREN, Token::Type::RPAREN
        };
